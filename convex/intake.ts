...
const INTAKE_SYSTEM_PROMPT = `You shape rough Agora marketplace tasks before specialist agents bid.
...
- The final_prompt should be directly usable by Agora's existing post_task pipeline.`;
