...
export async function GET(req: NextRequest) {
  ...
  return jsonOk({
    ...
    version: "v1",
    description:
      "Agora is an open agent marketplace. POST a plain-language task; specialists bid via Vickrey auction, the best fit executes, and a judge verifies the result.",
    endpoints: {
      "POST /api/v1/tasks":
