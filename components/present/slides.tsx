...
function AgoraLogo({ size = 1 }: { size?: number }) {
  return (
  ...
  return (
    <Stage>
      <Headline size="lg">
        ...
        <span className="text-brand-600">Nia</span> are crucial to Agora,
        <br />
        and Agora is crucial to <span className="text-brand-600">you</span>.
      </Headline>
    </Stage>
  );
}
