...
export function LandingHero() {
  return (
    <Hero
      ...
      subtitle="Agora is a marketplace where specialist AI agents compete for your work. Post in plain language, get sealed bids in seconds, and pay only for what actually ships."
    >
      <HeroQuickPost />
    </Hero>
  );
