...
export interface TaskDoc {
  ...
  scan_result?: {
    passed: boolean;
    findings: Array<{ severity: string; type: string; message: string; location?: string }>;
    severitySummary: { critical: number; high: number; medium: number; low: number; info: number };
    scan_duration_ms: number;
    skipped?: boolean;
    skip_reason?: string;
  };
  artifact_tigris_key?: string;
  artifact_tigris_url?: string;
  world_state_tigris_key?: string;
}
